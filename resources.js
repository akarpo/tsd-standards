...
window.RESOURCES = {
  ...
  "math:gK-CC": [
    ...
    { type: "course", name: "★Top  Eureka Math / EngageNY K-2 (free)", url: "https://www.engageny.org/ccls-math", note: "Free national curriculum; rigorous K-12 math (now Great Minds)" },
    { type: "course", name: "Illustrative Mathematics K-5 (free via Kendall Hunt)", url: "https://accessim.org/k-5", note: "Free, IM-authored K-5 curriculum" },
    { type: "course", name: "Open Up Resources K-5 Math (planned/free)", url: "https://openupresources.org/math-curriculum/" },
    { type: "course", name: "Bridges in Mathematics — overview + scope & sequence", url: "https://www.mathlearningcenter.org/curriculum/bridges", note: "Math Learning Center — partial free resources" },
    { type: "tool", name: "★Top  Beast Academy Playground (free, AoPS)", url: "https://playground.beastacademy.com/", note: "Free advanced puzzles from Art of Problem Solving" },
    { type: "tool", name: "Greg Tang Math — free puzzles & games", url: "https://gregtangmath.com/" },
    { type: "tool", name: "Bedtime Math — free daily problems for K-5", url: "https://bedtimemath.org/" },
    { type: "tool", name: "Toy Theater — free interactive math manipulatives", url: "https://toytheater.com/category/math-games/" },
    { type: "tool", name: "Math Playground — free K-6 games", url: "https://www.mathplayground.com/" },
    { type: "tool", name: "Coolmath4kids — free games + puzzles", url: "https://www.coolmath4kids.com/" },
    { type: "video", name: "Numberblocks (BBC, on YouTube) — free animated number sense", url: "https://www.youtube.com/playlist?list=PLDUKkIRc-YyV1nIqspQk9-rE0lZJ-wFxd" },
    { type: "practice", name: "Math Kangaroo USA — Levels 1-2 (advanced K-2 enrichment)", url: "https://mathkangaroo.org/mks/" }
  ],
  "math:gK-OA": [
  ...
  "math:g3-OA": [
    ...
    { type: "course", name: "★Top  Eureka Math / EngageNY Gr 3-5 (free)", url: "https://www.engageny.org/ccls-math" },
    { type: "course", name: "Illustrative Mathematics 3-5 (free)", url: "https://accessim.org/3-5" },
    { type: "course", name: "Open Up Resources K-5 Math (free)", url: "https://openupresources.org/math-curriculum/" },
    { type: "course", name: "Bridges in Mathematics scope & sequence", url: "https://www.mathlearningcenter.org/curriculum/bridges" },
    { type: "course", name: "★Top  Beast Academy Playground (free, AoPS)", url: "https://playground.beastacademy.com/", note: "Free advanced puzzles + sample lessons (Beast Academy is the gold-standard advanced K-5 curriculum)" },
    { type: "practice", name: "★Top  AoPS Alcumus — free adaptive practice", url: "https://artofproblemsolving.com/alcumus", note: "Goes from elementary through HS — Art of Problem Solving's free skill builder" },
    { type: "course", name: "Math Olympiad for Elementary & Middle School (MOEMS)", url: "https://www.moems.org/", note: "National Gr 4-6 math olympiad; sample problems online" },
    { type: "practice", name: "Math Kangaroo USA (Levels 3-4)", url: "https://mathkangaroo.org/mks/" },
    { type: "course", name: "AoPS Wiki — algebra, number theory, geometry essays", url: "https://artofproblemsolving.com/wiki", note: "Free encyclopedia of competition math" },
    { type: "video", name: "Numberphile — short videos on advanced math ideas", url: "https://www.youtube.com/@numberphile" },
    { type: "video", name: "3Blue1Brown — visual essays on advanced concepts", url: "https://www.youtube.com/@3blue1brown" },
    { type: "text", name: "Better Explained — intuition-first explanations of math concepts", url: "https://betterexplained.com/" },
    { type: "tool", name: "Greg Tang Math — advanced puzzles + Word Problem Generator", url: "https://gregtangmath.com/" },
    { type: "course", name: "MIT BLOSSOMS — Mathematics video lessons (some accessible to Gr 4-5)", url: "https://blossoms.mit.edu/videos/by_subject/mathematics" }
  ],
  "math:g3-NBT": [
  ...
  "math:g6-RP": [
    ...
    { type: "course", name: "★Top  Illustrative Mathematics 6-8 / Open Up Resources (free)", url: "https://im.kendallhunt.com/MS/", note: "Free, top-rated 6-8 math curriculum (NCTQ Tier 1)" },
    { type: "course", name: "★Top  Eureka Math / EngageNY Gr 6-8 (free)", url: "https://www.engageny.org/ccls-math" },
    { type: "course", name: "Open Up Resources 6-8 Math curriculum (free)", url: "https://openupresources.org/math-curriculum/grade-6-8/" },
    { type: "course", name: "MIT BLOSSOMS — Algebra & Geometry video lessons (Gr 7+)", url: "https://blossoms.mit.edu/videos/by_subject/mathematics" },
    { type: "course", name: "★Top  Art of Problem Solving — Introduction series (Pre-Algebra, Algebra, Number Theory, Counting)", url: "https://artofproblemsolving.com/store/list/aops-curriculum", note: "Books are paid; class textbooks viewable online; free Alcumus + AoPS Wiki cover same material" },
    { type: "practice", name: "★Top  AoPS Alcumus (free adaptive practice)", url: "https://artofproblemsolving.com/alcumus" },
    { type: "course", name: "AMC 8 (American Math Competition, Gr 6-8)", url: "https://www.maa.org/math-competitions/amc-8", note: "National competition; past problems publicly available" },
    { type: "course", name: "MATHCOUNTS — middle school competition program", url: "https://www.mathcounts.org/programs", note: "Free curriculum, problem-of-the-week, club resources" },
    { type: "course", name: "Math Olympiad for Middle School (MOEMS Division M)", url: "https://www.moems.org/" },
    { type: "practice", name: "Math Kangaroo USA (Levels 5-8)", url: "https://mathkangaroo.org/mks/" },
    { type: "text", name: "AoPS Wiki — competition math reference (free)", url: "https://artofproblemsolving.com/wiki" },
    { type: "text", name: "Better Explained — algebra/geometry intuition", url: "https://betterexplained.com/" },
    { type: "video", name: "3Blue1Brown — Essence of Algebra/Linear Algebra (advanced)", url: "https://www.youtube.com/@3blue1brown" },
    { type: "video", name: "Numberphile — advanced math curiosities", url: "https://www.youtube.com/@numberphile" },
    { type: "video", name: "Stand-up Maths (Matt Parker) — math humor + insight", url: "https://www.youtube.com/@standupmaths" },
    { type: "tool", name: "Mathigon Polypad — virtual manipulatives", url: "https://polypad.amplify.com/" },
    { type: "tool", name: "Project Euler — math + programming problems (advanced)", url: "https://projecteuler.net/" },
    { type: "course", name: "MIT OCW Highlights for High School — Algebra & Geometry", url: "https://ocw.mit.edu/high-school/mathematics/" }
  ],
  "math:g6-NS": [
  ...
  "math:gAlg1-N": [
    ...
    { type: "course", name: "★Top  Illustrative Mathematics HS (Algebra 1 / Geometry / Algebra 2)", url: "https://im.kendallhunt.com/HS/", note: "Free, top-rated HS math curriculum (NCTQ Tier 1)" },
    { type: "course", name: "Phillips Exeter Academy — Math 1-4 problem sets (free)", url: "https://www.exeter.edu/mathematics/math-materials", note: "Renowned Harkness-style problem-based curriculum" },
    { type: "course", name: "★Top  EngageNY / Eureka Math HS curriculum (free)", url: "https://www.engageny.org/ccls-math" },
    { type: "course", name: "MIT BLOSSOMS — HS Algebra/Geometry/Trig video lessons", url: "https://blossoms.mit.edu/videos/by_subject/mathematics" },
    { type: "course", name: "Saylor Academy — College Algebra (free, self-paced)", url: "https://learn.saylor.org/course/view.php?id=12" },
    { type: "course", name: "★Top  AoPS Online courses (Intro/Intermediate Algebra, Geometry, Number Theory, Counting)", url: "https://artofproblemsolving.com/online", note: "Paid courses; free Alcumus + AoPS Wiki provide same content & practice" },
    { type: "practice", name: "★Top  AoPS Alcumus (free adaptive practice)", url: "https://artofproblemsolving.com/alcumus" },
    { type: "course", name: "AMC 10/12 (American Math Competition, HS)", url: "https://www.maa.org/math-competitions/amc-1012", note: "Past problems + solutions free online" },
    { type: "course", name: "AIME (American Invitational Math Exam) — for AMC 10/12 qualifiers", url: "https://www.maa.org/math-competitions/aime" },
    { type: "course", name: "USAMTS — USA Math Talent Search (free, no entry fee)", url: "https://www.usamts.org/", note: "Year-long olympiad-style; full proofs required" },
    { type: "text", name: "AoPS Wiki — comprehensive competition math reference", url: "https://artofproblemsolving.com/wiki" },
    { type: "text", name: "Better Explained — algebra/calculus intuition", url: "https://betterexplained.com/" },
    { type: "text", name: "Cut the Knot — advanced math problems & proofs", url: "https://www.cut-the-knot.org/" },
    { type: "video", name: "3Blue1Brown — Essence of Linear Algebra / Calculus", url: "https://www.youtube.com/@3blue1brown" },
    { type: "video", name: "Numberphile — advanced math curiosities", url: "https://www.youtube.com/@numberphile" },
    { type: "video", name: "Eddie Woo (mister woo) — full HS math YouTube channel", url: "https://www.youtube.com/@misterwootube" },
    { type: "video", name: "Professor Leonard — full lecture-style HS/college math", url: "https://www.youtube.com/@ProfessorLeonard" },
    { type: "course", name: "MIT OCW Highlights for High School — Algebra/Geom/PreCalc", url: "https://ocw.mit.edu/high-school/mathematics/" },
    { type: "tool", name: "Project Euler — advanced math + programming problems", url: "https://projecteuler.net/" },
    { type: "tool", name: "Mathigon Polypad — virtual manipulatives + interactive", url: "https://polypad.amplify.com/" }
  ],
  "math:gAlg1-A": [
  ...
  "ela:gK-RL": [
    ...
    { type: "course", name: "★Top  Core Knowledge Language Arts (CKLA) — full K-5 curriculum", url: "https://www.coreknowledge.org/curriculum/language-arts/", note: "Free, content-rich, knowledge-building curriculum used at top US public schools" },
    { type: "course", name: "EL Education K-5 ELA Curriculum", url: "https://curriculum.eleducation.org/curriculum/ela", note: "Free, NCTQ-rated 'green'; thematic modules + close reading" },
    { type: "course", name: "Open Up Resources Bookworms (K-5)", url: "https://openupresources.org/elementary-ela/", note: "Free K-5 reading + writing curriculum" },
    { type: "course", name: "EngageNY / NYSED ELA — Skills + Listening & Learning strands", url: "https://www.engageny.org/", note: "Original NYSED CCSS-aligned modules (now CKLA-derived)" },
    { type: "text", name: "LibriVox — free audiobooks of public-domain children's lit", url: "https://librivox.org/" },
    { type: "text", name: "Standard Ebooks — beautifully typeset public-domain books", url: "https://standardebooks.org/" },
    { type: "text", name: "Project Gutenberg — Children's Bookshelf", url: "https://www.gutenberg.org/wiki/Children%27s_Bookshelf_(Bookshelf)" },
    { type: "foundational", name: "The Measured Mom — free literacy printables (advanced K-2)", url: "https://www.themeasuredmom.com/" },
    { type: "foundational", name: "Phonics Hero — free demo + decodables", url: "https://www.phonicshero.com/" },
    { type: "free", name: "Storynory — free narrated children's stories", url: "https://www.storynory.com/" },
    { type: "free", name: "ABCya! — free K-5 literacy games", url: "https://www.abcya.com/" }
  ],
  "ela:gK-RI": [
    { type: "foundational", name: "Khan Academy Kids", url: "https://learn.khanacademy.org/khan-academy-kids/" },
  ...
  "ela:g3-RL": [
    ...
    { type: "course", name: "★Top  Core Knowledge Language Arts (CKLA) — Gr 3-5 modules", url: "https://www.coreknowledge.org/curriculum/language-arts/", note: "Free knowledge-building curriculum w/ rich content domains" },
    { type: "course", name: "EL Education Gr 3-5 ELA Curriculum", url: "https://curriculum.eleducation.org/curriculum/ela", note: "Free; NCTQ 'green' rated; module + skills blocks" },
    { type: "course", name: "Open Up Resources Bookworms (3-5)", url: "https://openupresources.org/elementary-ela/" },
    { type: "course", name: "EngageNY / NYSED ELA modules (Gr 3-5)", url: "https://www.engageny.org/" },
    { type: "course", name: "Achieve the Core — Gr 3-5 Read-Aloud + Close Reading tasks", url: "https://achievethecore.org/category/411/ela-literacy-lessons" },
    { type: "text", name: "Standard Ebooks — public-domain literature (Gr 3-5+)", url: "https://standardebooks.org/" },
    { type: "text", name: "Project Gutenberg — full library", url: "https://www.gutenberg.org/" },
    { type: "text", name: "Bartleby — free classic literature", url: "https://www.bartleby.com/" },
    { type: "text", name: "Internet Archive — free books (incl. Newbery winners)", url: "https://archive.org/" },
    { type: "text", name: "Library of Congress — Children's Lit Collections", url: "https://www.loc.gov/programs/teachers/" },
    { type: "tool", name: "Wordsift — free vocabulary visualizer", url: "https://wordsift.org/", note: "Visualize, define, group academic words from any text" },
    { type: "tool", name: "Rewordify — text simplifier (helps advanced learners scaffold up)", url: "https://rewordify.com/" },
    { type: "free", name: "Listenwise — free educator tier (NPR-style listening lessons)", url: "https://listenwise.com/" },
    { type: "course", name: "National History Day — research-based ELA + history project", url: "https://www.nhd.org/", note: "Top middle/HS research competition; uses primary sources" },
    { type: "course", name: "Scholastic Art & Writing Awards (Gr 7-12; gateway concepts at Gr 5+)", url: "https://www.artandwriting.org/" }
  ],
  "ela:g3-RI": [
    { type: "khan", name: "Khan Academy: 3rd Grade Reading & Vocab", url: "https://www.khanacademy.org/ela/cc-3rd-reading-vocab" },
    { type: "text", name: "Newsela (free tier)", url: "https://newsela.com/" },
  ...
  "ela:g6-RL": [
    ...
    { type: "course", name: "★Top  EL Education Gr 6-8 ELA Curriculum (free)", url: "https://curriculum.eleducation.org/curriculum/ela", note: "NCTQ 'green'; module-based, college-prep rigor" },
    { type: "course", name: "Achieve the Core — Gr 6-8 close-reading tasks (CCSS-aligned)", url: "https://achievethecore.org/category/411/ela-literacy-lessons" },
    { type: "course", name: "EngageNY / NYSED ELA modules (Gr 6-8)", url: "https://www.engageny.org/" },
    { type: "course", name: "EDSITEment (NEH) — middle-school humanities lesson plans", url: "https://edsitement.neh.gov/" },
    { type: "course", name: "Stanford History Education Group — Reading Like a Historian", url: "https://sheg.stanford.edu/history-lessons", note: "Free document-based critical-reading curriculum" },
    { type: "text", name: "Library of America — Story of the Week (free)", url: "https://storyoftheweek.loa.org/" },
    { type: "text", name: "Modern American Poetry (Univ. of Illinois)", url: "https://www.modernamericanpoetry.org/" },
    { type: "text", name: "Standard Ebooks — public-domain literature", url: "https://standardebooks.org/" },
    { type: "text", name: "HathiTrust Digital Library — free scholar editions", url: "https://www.hathitrust.org/" },
    { type: "course", name: "Yale Open Courses — English (preview HS-track lectures)", url: "https://oyc.yale.edu/english" },
    { type: "course", name: "Khan Academy — Pre-AP English 1 path (Gr 9 Honors prep)", url: "https://www.khanacademy.org/ela/cc-9th-reading-vocab" },
    { type: "course", name: "Pre-AP English 1 Course Guide (PDF) — feeder syllabus", url: "https://pre-ap.collegeboard.org/media/pdf/pre-ap-english-cg-wr.pdf" },
    { type: "course", name: "National History Day (research + writing competition)", url: "https://www.nhd.org/" },
    { type: "course", name: "Scholastic Art & Writing Awards (Gr 7-12)", url: "https://www.artandwriting.org/" },
    { type: "course", name: "National Speech & Debate Association — Middle School Resources", url: "https://www.speechanddebate.org/student-resources/" },
    { type: "tool", name: "MIT OCW Highlights for High School — Humanities & Lit", url: "https://ocw.mit.edu/high-school/humanities-and-social-sciences/" }
  ],
  "ela:g6-RI": [
    { type: "khan", name: "Khan Academy: 6th Grade Reading & Vocab", url: "https://www.khanacademy.org/ela/cc-6th-reading-vocab" },
    { type: "text", name: "Newsela", url: "https://newsela.com/" },
  ...
  "ela:g910-RL": [
    ...
    { type: "course", name: "★Top  EL Education 9-12 ELA Curriculum (free)", url: "https://curriculum.eleducation.org/curriculum/ela/9-12", note: "NCTQ 'green'; explicit AP-track alignment" },
    { type: "course", name: "Stanford History Education Group — HS document-based units", url: "https://sheg.stanford.edu/history-lessons" },
    { type: "course", name: "MIT OCW Highlights for High School — Humanities", url: "https://ocw.mit.edu/high-school/humanities-and-social-sciences/" },
    { type: "course", name: "edX HarvardX — Masterpieces of World Lit (free audit)", url: "https://www.edx.org/learn/literature/harvard-university-masterpieces-of-world-literature" },
    { type: "course", name: "Saylor Academy — ENGL202: World Literature (free)", url: "https://learn.saylor.org/course/view.php?id=10" },
    { type: "course", name: "National History Day — research-paper / website / documentary track", url: "https://www.nhd.org/" },
    { type: "course", name: "Scholastic Art & Writing Awards (national HS writing competition)", url: "https://www.artandwriting.org/" },
    { type: "course", name: "John Locke Institute Essay Competition (advanced HS)", url: "https://www.johnlockeinstitute.com/essay-competition" },
    { type: "text", name: "Library of America — Story of the Week (curated American canon)", url: "https://storyoftheweek.loa.org/" },
    { type: "text", name: "American Verse Project — public-domain American poetry", url: "https://quod.lib.umich.edu/a/amverse" }
  ],
  "ela:g910-RI": [
